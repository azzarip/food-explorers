...
<article class="max-w-3xl mx-auto">
    ...
    <p class="font-serif text-2xl lg:text-3xl font-semibold text-center mt-4 mx-auto max-w-xl mb-4">A <span class="text-amber-800">culinary journey</span>  through authentic flavors at <span class="text-red-800">a fatt</span></p>
    ...
    <div class="space-y-4">
        ...
        <p><strong>A Fatt</strong>, located near Limmatplatz, is considered by many the best Malaysian restaurants in Zurich, with <strong>4.7 <x-heroicon-s-star class="text-amber-600 w-6 h-6 inline"/> on Google Maps</strong>.</p> 
    ...
    <ul class="pl-4 space-y-4">
        ...
        <p> It is a crispy, golden delight with a silky, custard-like center. Lightly battered and fried to perfection, it's tossed in fragrant garlic, fiery chili, and Sichuan pepper for an irresistible kick.</p>
        </li>
