    ...
    <article class="max-w-3xl mx-auto">
        ...
        <div class="space-y-4">
            ...
            <p>On <strong>Wednesday 5. March</strong>, the team at <strong class="text-red-800">A Fatt</strong> restaurant
                will welcome us for an <strong>unforgettable dining experience</strong>, where we'll explore a variety of
            ...
            <p>You will <strong class="text-amber-900">share and savor</strong> the incredible diversity of Malaysian
                cuisine.</p>
            <p>This is a popular style of eating in Malaysia, where meals are meant to be shared with friends. </p>
            <p>It’s a truly social way to dine, and you’ll get to <strong>enjoy a wide variety of dishes</strong> that
                showcase the <strong>fragrant flavors of Malaysia</strong>.</p>
            <p>To ensure an <strong>authentic experience</strong>, we have worked closely with the chef to craft a special
                menu that highlights the most traditional and beloved Malaysian dishes. </p>
        ...
        <x-button link="#offer"> Reserve now your seat! </x-button>
        <h2 class="mt-12 mb-4 font-serif text-2xl font-semibold">How is the dinner organized?</h2>
        <div class="mt-6 space-y-4">
            <p>The dinner is served in <strong>authentic Chinese style</strong> where all the dishes are served in trays in
            ...
            <p>Throughout the evening, all the dishes will come in various rounds out of the kitchen giving you the
                opportunity to try a wide selection of the menu.</p>
            <p>All the dishes will be <strong>shared</strong> among the guests, you can eat what you want out of the shared
                dishes.</p>
            <p>Drinks, beers, and water are not included. But you can order them and pay for it at the check out.</p>
        </div>
        <img src="https://cdn.i-scmp.com/sites/default/files/styles/1020x680/public/d8/images/canvas/2024/10/21/cbd16316-01fe-4fce-9605-74396af0bac6_930eaeb7.jpg?itok=XUQgmjCJ&v=1729485365"
            alt="Chinese Dinner" class="my-4 rounded drop-shadow-lg">
        <div class="mt-6 space-y-4">
            <h2 class="mt-6 mb-4 font-serif text-2xl font-semibold" id="offer">Only for you coming to Milano</h2>
        ...
        <div class="space-y-2">
            <h3 class="block pt-4 text-xl font-semibold">Can the dishes be changed?</h3>
            ...
            <h3 class="block pt-4 text-xl font-semibold">Are the dishes spicy?</h3>
            ...
            <h3 class="block pt-4 text-xl font-semibold">What if I have an allergy?</h3>
            <p>Please let me know at <a href="mailto:marco.azzari@foodexplorers.ch"
                    class="font-semibold">marco.azzari@foodexplorers.ch</a> if you have any allergies before booking the
                event.</p>
            <p>The dishes cannot be changed but we can inform you of any allergens.</p>



            <h3 class="block pt-4 text-xl font-semibold">What if I cannot come?</h3>
            ...
            <p>The participation is not nominative, in case you cannot join, you can give your place to someone else. (You
                have to find that person.)</p>
...
@push('scripts')
    <script>
        ...
        const targetDate = new Date('2025-02-16T13:00:00Z').getTime();
