...
<html lang="en">
  ...
  <body style="margin:0; padding:0; background:#f6f6f6; -webkit-font-smoothing:antialiased; font-family:Arial,Helvetica,sans-serif;">
    <!-- Preheader (hidden) -->
    <div style="display:none; max-height:0; overflow:hidden; opacity:0; mso-hide:all;">
      Zurich Wine Compass — tastings from {{ $loader->start->format('j F') }} to {{ $loader->end->format('j F') }}
    </div>

    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f6f6f6; margin:0; padding:24px 0;">
      <tr>
  ...
  See Full Calendar
              ...
              <td style="padding:10px 28px 6px 28px;">
                <p><strong>P.S.</strong> Anything we can improve? Or you would like to have? Let us know replying to this email!</p>
              </td>
            </tr>
            <!-- Footer -->
            <tr>
