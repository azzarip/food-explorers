    ...
    <main class="mb-12 ">
                ...
                <div class="text-center mt-2">
                    ...
                    <h1 class="mt-4 text-3xl font-extrabold leading-tight text-gray-900 sm:text-4xl md:text-5xl space-y-3">
                        ...
                        <p class="font-semibold">
                            Join the <span
                                class="font-bold mt-1 bg-gradient-to-r from-rose-600 to-fuchsia-600 bg-clip-text text-transparent">Zurich
                                Wine Compass</span> and stay one glass ahead.
                        </p>
                        <p class="text-2xl lg:text-4xl font-extrabold">Don’t let the next bottle be opened without you 🍾</p>
                    </h1>

                    <p
                        class="mx-auto mt-4 w-fit px-8 py-2 border-cyan-600 font-semibold text-base md:text-lg bg-gradient-to-r from-blue-600 to-cyan-800 border-2 rounded-full bg-clip-text text-transparent">
        ...
        <article class="mx-auto max-w-3xl px-2 mt-8 space-y-3 lg:text-xl">
            ...
            <div class="text-center px-12 font-bold text-2xl leading-relaxed">
                👉 The only complete insider calendar of every single wine tasting happening in Zürich — delivered straight
                to your inbox, before the corks are even pulled.
            </div>
            <p>❌ No searching.</p>
            <p>❌ No remembering.</p>
            <p>❌ No relying on your calendar.</p>
            <p>With the <strong>Zurich Wine Compass</strong>, you’ll always know when and where the next tasting is
                happening — and you’ll never miss any bottle again.</p>
            ...
            <p>You have to spend hours hunting, looking at emails nobody reads, and often you hear about them <em>only
                    after</em> they happened.</p>
            ...
            <p>Zurich Wine Compass is your <strong>weekly email</strong> that informs you about all the upcoming events in
                the city.</p>
            ...
            <ul class="space-y-2">
                <li>🍷 <strong>Every tasting in one place</strong> — no more endless scrolling, searching, or asking around.
                </li>
            ...
            <a href="#form">
                <div
                    class="text-center my-4 w-full rounded-xl bg-rose-600 px-6 py-3 text-base cursor-pointer font-semibold text-white shadow-md transition hover:bg-rose-700 focus:outline-none focus:ring-4 focus:ring-rose-200">
            ...
            <p>We also have a Whatsapp and Telegram Channel if you prefer these ways over emails, after you join we will
                welcome you into those groups!</p>
