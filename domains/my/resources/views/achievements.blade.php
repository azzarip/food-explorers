...
<div x-data="{'open': 'restaurants'}" class="mb-12">
    <div class="grid grid-cols-3 mt-8 min-w-md lg:px-12 lg:mt-18">
        ...
        >
            <h2 class="font-semibold text-center md:text-xl lg:mt-4 lg:text-2xl">Food & Restaurants</h2>
        </div>
        ...
        @click = "open = 'bars'"
        >
            <h2 class="font-semibold text-center md:text-xl lg:mt-4 lg:text-2xl">Bars & Drinks</h2>
        </div>
        ...
        >
            <h2 class="font-semibold text-center md:text-xl lg:mt-4 lg:text-2xl">Adventures</h2>
    ...
    <section x-show="open == 'restaurants'" class="max-w-xl py-6 mx-auto mt-6 space-y-8 max-lg:px-2">
        ...
        <x-my::achievements.restaurant
            ...
            description='A celebration of the art of Italian pizza in Zurich. Experience an authentic tasting journey at the city’s most renowned pizzeria, where tradition and flavor come together in every bite.'        /> 
