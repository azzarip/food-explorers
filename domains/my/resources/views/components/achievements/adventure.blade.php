...
<div class="flex items-start gap-4 py-4 pl-4 border-2 rounded-lg {{ $active ? ' border-yellow-700  shadow-lg bg-linear-to-br from-yellow-200 via-yellow-300 to-yellow-400' : ''}}">
    ...
    <div>
        ...
        <p class="italic max-lg:text-sm text-md @if(!$unlocked) select-none blur-xs @endif">{{ $description }}</p>
    </div>
</div>