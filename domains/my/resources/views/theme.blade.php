                    ...
                    <div id="top">
                        ...
                        <nav>
                            <ul>
                                ...
                                @php($selectedEvents = str_starts_with(request()->path(), 'event'))
                                <li>
                                    <a class="block w-full py-3 pl-4 border-yellow-400/80  {{ $selectedEvents ? 'bg-gray-700 border-l-4' : 'hover:bg-gray-800' }}"
                                        href="/events">
                                        @if($selectedEvents)
                                ...
                                <li>
                                    <a class="block w-full py-3 pl-4 border-yellow-400/80 {{ $selectedAchievements ? 'bg-gray-700 border-l-4' : 'hover:bg-gray-800' }}"
                                        href="/achievements">
                                ...
                                <li>
                                    <a class="block w-full py-3 pl-4 border-yellow-400/80  {{ $selectedSuggest ? 'bg-gray-700 border-l-4' : 'hover:bg-gray-800' }}"
                                        href="/suggest">
                                        @if($selectedSuggest)
