...
@section('main')
    <article class="max-w-2xl mx-auto px-2 mb-12">
        ...
        <p>One of the reasons I organize these trips is to create a <strong>real escape</strong>: to bring you out of Zurich, away from the routine, away from work emails buzzing in your pocket.</p>
        <p>Just you, your passions, amazing foods and drinks and a weekend that feels like a breath of fresh air.</p>
        <p>For the same reason, I will personally print the entire program and send it to you, at my own expenses.</p>
        <p>Because I believe in real experiences. Because I want you to feel, even before the trip begins, how much care and love I put into <strong>crafting every detail</strong>.</p>
