...
<x-forms::base :action="route('soft-auth')" button="Continue">
        @csrf
        @error('user')
...
<a href="{{ request()->url() }}?v=login"
    class="block w-full max-w-lg py-1 mx-auto text-xl text-center border-4 border-yellow-500 rounded-full hover:bg-yellow-500">
